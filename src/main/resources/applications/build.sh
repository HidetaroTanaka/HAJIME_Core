...
riscv64-unknown-elf-gcc -I ./common -DPREALLOCATE=1 -mcmodel=medany -static -std=gnu99 -O2 -fno-common -fno-builtin-printf -fno-tree-loop-distribute-patterns -march=rv64i -mabi=lp64 -o median.riscv ./median/median.c ./median/median_main.c ./common/syscalls.c ./common/crt.S -static -nostdlib -nostartfiles -T ./common/test.ld
...
cat median_data.temp median_rodata_str1_8.temp > median_data.hex

riscv64-unknown-elf-gcc -I ./common -DPREALLOCATE=1 -mcmodel=medany -static -std=gnu99 -O2 -fno-common -fno-builtin-printf -fno-tree-loop-distribute-patterns -march=rv64i -mabi=lp64 -o helloworld.riscv ./helloworld/helloworld.c ./common/syscalls.c ./common/crt.S -static -nostdlib -nostartfiles -T ./common/test.ld
...
hexdump -v -e '1/1 "%02x" "\n"' helloworld_rodata_str1_8.bin > helloworld_data.hex
