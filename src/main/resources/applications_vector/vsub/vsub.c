...
int vl, avl = 41;
  ...
  while(avl != 0) {
    ...
    :
    : "r"(ptr1));
    asm volatile ("vsub.vv v12, v10, v11");
    asm volatile ("vsub.vx v12, v12, t0");
    asm volatile ("vrsub.vx v12, v12, t1");
    asm volatile ("vrsub.vi v12, v12, 15");
  ...
  int i;
  for(i=0; i<41; i++) {
    answerArray[i] = -8474 + dataArray0[i] - dataArray1[i];
  }
